...
<body>
	...
	<div id="background">
		...
		<div id="loginContainer">
			...
			<div id="inputContainer">
				...
				<form id="registerForm" action="register.php" method="POST">
					...
					<div id="hasAccountText">
						<span id="hideRegister">Already hav an account? Login here.</span>
					</div>
				</form>
			...
			<div id="loginText">
				<h1>Get your favourite music, right here</h1>
				<h2>Listening lots of music anytime anywhere</h2>
				<ul>
					<li>Discover music,artists you can love with</li>
					<li>Create your own playlist</li>
					<li>Follow us to get up to date</li>
				</ul>
			</div>
		</div>
	</div>
